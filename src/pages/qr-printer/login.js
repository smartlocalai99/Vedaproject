          ...
          <label className="block">
            ...
            <span className="relative block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#B97943] py-3 pl-[72px] pr-4 text-base outline-none focus:ring-2 focus:ring-orange-200"
          ...
          <label className="block">
            ...
            <span className="relative block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#B97943] py-3 pl-12 pr-12 text-base outline-none focus:ring-2 focus:ring-orange-200"

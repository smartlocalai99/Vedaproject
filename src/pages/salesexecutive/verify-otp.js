...
//       router.push(
//         `/salesexecutive/reset-password?email=${encodeURIComponent(
//           email
//         )}`
//       );
//     } catch (error) {
...
//                   secondsLeft <= 0
//                 }
//                 className="w-full h-[54px] mt-6 rounded-[14px] bg-[#8a451a] text-white text-[15px] font-semibold transition hover:bg-[#753a17] disabled:opacity-50 disabled:cursor-not-allowed"
//               >
//                 {loading
//                   ? "Verifying..."
//                   : "Verify OTP"}
...
//                   resendSeconds > 0
//                 }
//                 className="mt-2 text-[14px] font-semibold text-[#8a451a] disabled:text-[#aaa09a] disabled:cursor-not-allowed"
//               >
//                 {resending
//                   ? "Sending..."
//                   : resendSeconds > 0
...
//             {/* SECURITY TEXT */}
//             <div className="mt-7 pt-5 border-t border-[#eee5de]">
//               <p className="text-center text-[12px] leading-5 text-[#99908a]">
//                 For your security, this OTP is valid for
